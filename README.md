...
Assuming we want to calculate the time it takes to deliver the package to location number X in some individual. 
...
In our examples, we wanted to refer to realistic situations as much as possible. <br>
